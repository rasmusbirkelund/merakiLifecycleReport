...
2. Make sure to have your API key as an environment variable
```
...
6. **Unassigned Units:** Count of units that are unassigned of the specified SKU in the organization. 
7. **Assigned Units:** Count of units that are assigned of the specified SKU in the organization. 
8. **Total Units:** Count of total units in use of the specified SKU in the organization. Contains the sum of Unassigned and Assigned units. 
